 ...
 * @param {Object} ops
 */
var EpmServer = module.exports = function(dir, ops) {
  var self = this;
...
EpmServer.prototype.listen = function(ops){
  ...
  self.findRepositories(function(err, epms){
      
    // instance Epm's
    epms.forEach(function(edir){
      var e = new Epm(edir);
 ...
 */
EpmServer.prototype.write = function(obj, res, statusCode) {
  var self = this;
