...
Explorer.prototype.discover = function(cb) {
  ...
  getFiles(self.PATH, function(err, files){
    ...
    , function(err, results){
      ...
      if (results.length === 0) {
        // repository empty, nothing to do
        if (typeof cb === 'function') {
          cb.apply(self, [null, tracked, res]);
        }
        return;
      }
      ...
      // save the files on read
      if ( (deleteds.length | Object.keys(addeds).length | Object.keys(changes).length) !== 0 ) {
